...
def run_boltz2_xray_refinement(
    ...
    # ------------------------------------------------------------------
    # Seed pre-scan (inline, in the refinement's own sampling mode).
    #
    ...
    #
    # The scan runs in the SAME sampling mode as refinement (TBPTT / single_step
    # / DDIM) because the seed -> structure mapping is mode-dependent: the seed
    # that is best under full TBPTT sampling is not necessarily best under DDIM.
